function [trainedClassifier, validationAccuracy, X1, Y1, AUC1, C, C_percent, valid_mat] = classify_4inputs_B(trainingData,predictorNames)
...
% Auto-generated by MATLAB on 15-Aug-2019 10:03:27
...
%predictorNames = {'VOMS', 'Symp_Score', 'SAC', 'BESS'}; %Send the predictorName to classify_4
...
trainedClassifier.RequiredVariables = predictorNames; %{'BESS', 'SAC', 'Symp_Score', 'VOMS'};
...
% model.
inputTable = trainingData;
predictorNames = predictorNames; %{'VOMS', 'Symp_Score', 'SAC', 'BESS'};
predictors = inputTable(:, predictorNames);
response = inputTable.Concussion;
isCategoricalPredictor = [false, false, false, false];
