function [trainedClassifier, validationAccuracy, X1, Y1, AUC1, C, C_percent, valid_mat] = classify_1inputs_B(trainingData,predictorNames )
...
% Auto-generated by MATLAB on 15-Aug-2019 10:21:35
...
%predictorNames = {'VOMS'}; %Send the predictorName to classify_1
...
trainedClassifier.RequiredVariables = predictorNames; %{'VOMS'};
...
% model.
inputTable = trainingData;
predictorNames = predictorNames; %{'VOMS'};
predictors = inputTable(:, predictorNames);
response = inputTable.Concussion;
isCategoricalPredictor = [false];
