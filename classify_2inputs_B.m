function [trainedClassifier, validationAccuracy, X1, Y1, AUC1, C, C_percent, valid_mat] = classify_2inputs_B(trainingData,predictorNames)
...
% Auto-generated by MATLAB on 15-Aug-2019 10:17:49
...
%predictorNames = {'VOMS', 'Symp_Score'}; %Send the predictorName toclassify_2
...
trainedClassifier.RequiredVariables =  predictorNames; %{'Symp_Score', 'VOMS'};
...
% model.
inputTable = trainingData;
predictorNames =  predictorNames; %{'VOMS', 'Symp_Score'};
predictors = inputTable(:, predictorNames);
response = inputTable.Concussion;
isCategoricalPredictor = [false, false];
...
% AUC stuff
%[X1,Y1,~,AUC1]=perfcurve(validationResponse,validationScores(:,2), 1,'XVals');
[X1,Y1,~,AUC1]=perfcurve(validationResponse,validationScores(:,2), 1,'XVals',(0:0.001:1) );
