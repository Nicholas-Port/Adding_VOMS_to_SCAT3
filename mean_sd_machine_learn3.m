function [ mean_auc, sd_auc, X, Y, C_percent, d] = mean_sd_machine_learn3(trainingData,predictorNames, n_inputs)
...
parfor i = 1 : 40
   ...
   switch n_inputs
      ...
      case 2
         [model, accuracy, d(i).x, d(i).y, d(i).AUC, d(i).C, d(i).C_percent, d(i).valid_mat] = classify_2inputs_B_SVM(trainingData,predictorNames);
      case 3
